...
const store =createStore(TabsReducer, window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__());
...
ReactDOM.render(
  <Provider store={store}>
   <Router>
    ...
    <Route exact path="/orgs" component={RepositoriesTab}/>
